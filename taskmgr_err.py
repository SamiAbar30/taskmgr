'''
Buggy Task Manager Implementation
This code contains intentional bugs for testing purposes.
Lines 18, 24, 143, and 187 have been modified to introduce errors.
'''
...
PRIORITY_ORDER = {"LOW": 1, "MEDIUM": 2, "HIGH": 0} # Bug Insertion
...
DEFAULT_PRIORITY = "MEDIUM" # Bug Insertion
DEFAULT_REP = "NONE"
DEFAULT_DUE = "NONE"
...
def print_header_and_tasks(tasks: List[Dict[str, Any]], sort_by: str, direction: str):
    ...
    reverse = (direction == "asc") # Bug Insertion
...
def cmd_add(args: Dict[str, str], original: str):
    ...
    if "name" not in args:
        ...
        raise InvalidArgument() # Bug Insertion
